...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col space-y-10 pb-16">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-primary to-accent py-10 sm:py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <p className="text-dark-gray text-base sm:text-lg md:text-xl max-w-2xl">
          ...
          <Input
            ...
            className="w-full h-11 sm:h-12 placeholder:text-sm placeholder:text-gray-400"
          />
          <Input
            value={location}
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="h-11 sm:h-12 w-full justify-between text-sm sm:text-base">
                {jobTypes.length > 0 ? jobTypes.join(", ") : "Select Job Types"}
                <ChevronDown className="ml-2 h-4 w-4" />
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-[88vw] sm:w-60 max-w-sm">
              ...
              {/* Advanced Filters */}
                <div className="flex justify-end sm:justify-end">
                  <Button className="mt-2 sm:mt-3 md:mt-0 w-full md:w-auto bg-accent hover:bg-accent/90 text-white" onClick={handleSearch}>
            ...
            <div className="w-full max-w-4xl mt-2 sm:mt-4">
              <details className="bg-white rounded-lg shadow-md p-4 group">
                <summary className="font-semibold text-dark-gray cursor-pointer select-none flex items-center justify-between text-sm sm:text-base">
                  ...
                  <span className="text-xs font-normal text-gray-500 hidden sm:inline">Advanced</span>
                </summary>
                <div className="mt-4 space-y-3">
                  <div className="relative">
                    <Input
                      ...
                      className="w-full h-11 sm:h-12 pr-10 text-sm sm:text-base placeholder:text-sm placeholder:text-gray-400"
                    />
                    <button
                      type="button"
      ...
      <section className="container mx-auto max-w-6xl px-4">
        <h2 className="text-2xl sm:text-3xl font-bold text-dark-gray mb-5 sm:mb-8">Popular Job Categories</h2>
        <JobCategories />
      </section>

      {/* Featured Jobs */}
      <section className="container mx-auto max-w-6xl px-4">
        <h2 className="text-2xl sm:text-3xl font-bold text-dark-gray mb-5 sm:mb-8">Featured Jobs</h2>
        <FeaturedJobs />
      </section>
